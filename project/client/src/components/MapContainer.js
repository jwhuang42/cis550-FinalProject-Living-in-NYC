    ...
    return (
        <div class="googleMapContainer">
          ...
          <Map
            ...
            style={mapStyles}
            initialCenter={this.state.nyc? {lat: this.state.nyc[0].latitude, lng: this.state.nyc[0].longitude}: { lat: 40.7528, lng: -74.0060}}  //center of nyc { lat: 40.7528, lng: -74.0060}
          >
